...
export async function fetchIngresses(
  ...
  return request<API.Ingress[]>('/api/v1/ingresses', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function fetchIngressYaml(
  ...
  return request<string>('/api/v1/ingresses/one/yaml', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function fetchIngressWhiteList(
  ...
  return request<string[]>('/api/v1/ingresses/one/whitelist', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateIngressWhiteList(
  ...
  return request<API.Ingress>('/api/v1/ingresses/one/whitelist', {
    method: 'POST',
    data: {
      ...params,
    },
